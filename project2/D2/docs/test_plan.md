...
The long term plan will be comprehensive jUnit coverage for automated testing. This will make the testing iterations from unit to regression much more streamlined due to the automation and input repeatability. 
...
|---------------------------------------	|------------------------------------	|----------------------------------------------	|----------------------------------------------	|-----------	|-------	|
| Checkout a new customer               	| See manual.md for detailed steps.  	| Customer and transaction added to history.   	| Customer and transaction added to history.   	| PASS      	|       	|
| Checkout an existing customer         	| See manual.md for detailed steps.  	| Transaction added to history.                	| Transaction added to history.                	| PASS      	|       	|
| View a customer's transaction history 	| See manual.md for detailed steps.  	| List of customers transactions is displayed. 	| List of customers transactions is displayed. 	| PASS      	|       	|
| Edit a customer's information         	| See manual.md for detailed steps.  	| Customer's information is updated.           	| Customer's information is updated.           	| PASS      	|       	|

### Data and UI For Automated Unit Tests
...
### Functionality/Exploratory Testing
