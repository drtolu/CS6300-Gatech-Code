...
//		Log.e(LOG, selectQuery);
	...
	public List<Map<String, String>> getCustTransFormatted(String email) {
	    ...
	    String selectQuery = "SELECT  " + KEY_DATE  + ","  + KEY_AMOUNT + "," + KEY_CASHDISCOUNT + "," + KEY_GOLDDISCOUNT
	    ...
	    if (cursor.moveToFirst()) {
	        do {
	        	...
	        	if (Double.valueOf(cursor.getString(3)) > 0) 
	        		gold = "\n$" + String.valueOf(precision.format(Double.parseDouble(String.valueOf(cursor.getString(3))))) + " Gold Discount";
	        	
	        	Map<String, String> datum = new HashMap<String, String>(2);
    	        	datum.put("Date", cursor.getString(0));
    	            datum.put("Amount", amount + reward + gold);
    	            list.add(datum);
